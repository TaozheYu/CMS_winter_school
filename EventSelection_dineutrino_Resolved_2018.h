...
//BTAG SF
BTagCalibration calib("DeepCSV", "SF_dineutrino_2018/DeepCSV_102XSF_V1.csv");
...
*/
BTagCalibrationReader readerTIncl (BTagEntry::OP_TIGHT, "central", {"up", "down"});
BTagCalibrationReader readerTComb (BTagEntry::OP_TIGHT, "central", {"up", "down"});
BTagCalibrationReader readerMIncl (BTagEntry::OP_MEDIUM, "central", {"up", "down"});
BTagCalibrationReader readerMComb (BTagEntry::OP_MEDIUM, "central", {"up", "down"});
BTagCalibrationReader readerLIncl (BTagEntry::OP_LOOSE,  "central",  {"up", "down"});
BTagCalibrationReader readerLComb (BTagEntry::OP_LOOSE,  "central",  {"up", "down"});
//Lepton SF
...
/*TFile *fileOldPU         = new TFile("SF_dineutrino_2018/MyDataPileupHistogram2018.root");
TFile *fileNewPU         = new TFile("SF_dineutrino_2018/MyDataPileupHistogram2018.root");
TFile *fileNewPUUp       = new TFile("SF_dineutrino_2018/MyDataPileupHistogram2018Up.root");
TFile *fileNewPUDo       = new TFile("SF_dineutrino_2018/MyDataPileupHistogram2018Do.root");*/
TFile *fileOldPU         = new TFile("SF_dineutrino_2018/PileUpReweighting2018.root");
TFile *fileNewPU         = new TFile("SF_dineutrino_2018/PileUpReweighting2018.root");
TFile *fileNewPUUp       = new TFile("SF_dineutrino_2018/PileUpReweighting2018Up.root");
TFile *fileNewPUDo       = new TFile("SF_dineutrino_2018/PileUpReweighting2018Do.root");
TFile *fileZPt           = new TFile("SF_dineutrino_2018/scalefactors_v4.root");
//TFile *fileHT_SF         = new TFile("SF_dineutrino_2018/SF_2D_newJEC.root");
//TFile *fileHT_SF         = new TFile("SF_dineutrino_2018/SF_2D_vetoWtop.root");
TFile *fileHT_SF         = new TFile("SF_dineutrino_2018/SF_2D_BtagError.root");
...
TH2F   *histoSF1_BtagUp  = (TH2F*) fileHT_SF->Get("SF1_BtagUp_h");
TH2F   *histoSF2_BtagUp  = (TH2F*) fileHT_SF->Get("SF2_BtagUp_h");
TH2F   *histoSF3_BtagUp  = (TH2F*) fileHT_SF->Get("SF3_BtagUp_h");
TH2F   *histoSF1_BtagDown= (TH2F*) fileHT_SF->Get("SF1_BtagDown_h");
TH2F   *histoSF2_BtagDown= (TH2F*) fileHT_SF->Get("SF2_BtagDown_h");
TH2F   *histoSF3_BtagDown= (TH2F*) fileHT_SF->Get("SF3_BtagDown_h");
...
float w_ttbarUp=1;
float w_ttbarDown=1;
float w_ZToNuNu_BtagUp=1;
float w_WToLNu_BtagUp=1;
float w_ttbar_BtagUp=1;
float w_ZToNuNu_BtagDown=1;
float w_WToLNu_BtagDown=1;
float w_ttbar_BtagDown=1;
float w_Trig=1;
float w_TrigUp=1;
float w_TrigDown=1;
float w_HEM=1;
